 ...
 *
 */
public class CompanyMoneyCountVO {
    ...
    public CompanyMoneyCountVO(){

    }

    public CompanyMoneyCountVO(int phyStampCount, int phyStampCountMoney, int eleStampCount, int eleStampCountMoney) {
