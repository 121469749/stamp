 ...
 */
@Controller
@RequestMapping(value="${adminPath}/dealer/province/sub/user")
public class DealerProUserController extends BaseController {
    ...
    public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        //todo
        return "modules/jsps/dealer/subUser/proSubUserList";
    }
    ...
    public String form(User user, Model model){
        ...
        //过滤角色列表
        List<Role> roleList =dealerSubUserService.getSubDealerRoles(Role.DEPTTYPE_DEALER_PRO_SUB);

        model.addAttribute("allRoles", roleList);

        //todo
        return "modules/jsps/dealer/subUser/proSubUserForm";
    ...
    public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
        ...
        //todo
        return "redirect:" + adminPath + "/dealer/province/sub/user/list";
    }
