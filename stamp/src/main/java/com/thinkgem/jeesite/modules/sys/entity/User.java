...
public class User extends DataEntity<User> {
    ...
    private String certModulus;
    private String certFilePath;

    //枚举类型
    @Enumeration(enumClass = UserType.class)
   ...
   // private String userType;
    ...
    private String isSysrole;   //判断用户是否各部门管理员

    // 该用户的公司信息
    private Company companyInfo = new Company();

    // 该用户的公安机关单位信息
    private Police policeInfo = new Police();
    ...
    public User(UserType userType,String remarks){
        this.userType = userType;
...
//	}
    ...
    public Police getPoliceInfo() {
        return policeInfo;
    }

    public void setPoliceInfo(Police policeInfo) {
    ...
    public String getCertModulus() {
        return certModulus;
    }

    public void setCertModulus(String certModulus) {
        this.certModulus = certModulus;
    }
}