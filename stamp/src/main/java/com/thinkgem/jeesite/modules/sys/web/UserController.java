...
public class UserController extends BaseController {
    ...
    public String info(User user, HttpServletResponse response, Model model) {
        ...
        boolean hasCert = certificateService.checkCert(currentUser);
        model.addAttribute("hasCert",hasCert);
    ...
    public String modifyPwd(String oldPassword, String newPassword, Model model) {
        ...
        if (StringUtils.isNotBlank(oldPassword) && StringUtils.isNotBlank(newPassword)) {
            ...
            if (SystemService.validatePassword(oldPassword, user.getPassword())) {
                systemService.updatePasswordById(user.getId(),user.getUserType(), user.getLoginName(), newPassword);
    ...
    @RequestMapping(value = "applyCert")
    @ResponseBody
    public String applyCert(){
        User user = UserUtils.getUser();
        certificateService.generateCert(user);
        Condition<String> condition = new Condition<String>(Condition.SUCCESS_CODE);
    ...
    public String updateCert(){
        User user = UserUtils.getUser();
        certificateService.updateCert(user);
        Condition<String> condition = new Condition<String>(Condition.SUCCESS_CODE);
        return JsonMapper.toJsonString(condition);
    }
...
//    @ResponseBody
//    public String sentMessage(String phoneNumber){
