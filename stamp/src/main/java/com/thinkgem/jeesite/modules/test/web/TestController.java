...
//		return "redirect:" + adminPath + "/test/test/?repage";
	...
	public void testUpdate(HttpServletResponse response){
		testService.testUpdate();

	}

	@RequestMapping(value = "updateCertificate")
	public void updateCertificate(HttpServletResponse response){
		testService.updateCertificate();

	}

	@RequestMapping(value = "uploadImageTest")
	public String uploadImageTest(Test test, Model model) {
		model.addAttribute("test", test);
		return "modules/test/uploadImageTest";
	}

		@RequestMapping(value = "uploadPicTest")
	public String uploadPicTest(Test test, Model model) {
		model.addAttribute("test", test);
		return "modules/test/uploadPicTest";
	}
