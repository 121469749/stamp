...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            ...
            $("#searchForm").attr("action","${ctx}/dealer/count/rc/excelExport");
            $("#searchForm").submit();
            $("#searchForm").attr("action","${ctx}/dealer/count/rc/list");
        }
...
<form:form id="searchForm" modelAttribute="dto" action="${ctx}/dealer/count/rc/list"
           method="post"
    ...
    <div style="width: 1200px">
        ...
        <sys:treeselect id="area" name="area.id" value="${dto.area.id}"
                        labelName="area.name"
