...
<h4 style="width: 80%;color: #666;display: inline">(${currentAgencyCompany.area.name}总共可分配生产数量
   ...
   <%-- 个${currentAgencyCompany.phyCountSet.stampShape.value}，--%>
    个物理印章，
    ...
    个电子印章)</h4>
<form:form id="searchForm" modelAttribute="company" action="${ctx}/dealer/countSet/province/list" method="post"
        ...
        <tr>
            ...
            <td width="200px">
                <div style="width: 200px!important;">
                    <a href="${ctx}/dealer/countSet/province/form?companyId=${agency.id}">印章生产数量设定</a>&nbsp;&nbsp;&nbsp;&nbsp;
