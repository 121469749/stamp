        ...
        $(document).ready(function () {
            ...
            $("#save").click(function () {
                ...
                $('#submitForm').ajaxSubmit({
                    dataType: 'json',
                    type: "post",
                    url: "${ctx}/dealer/countSet/city/save",
                    success: function (result) {
                        console.log(result);
                        <%--提示信息，成功后跳转，失败后按钮重新变为可点击--%>
                        alert(result.message);
                        if (result.code == 200) {
                            window.location = "${ctx}/dealer/countSet/city/list";
                        } else {
...
<form:form id="submitForm" modelAttribute="agencyCompany" method="post" action="${ctx}/dealer/countSet/city/save">
