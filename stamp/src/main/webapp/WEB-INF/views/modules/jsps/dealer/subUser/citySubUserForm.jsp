...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#inputForm").validate({
                rules: {
                    loginName: {remote: "${ctx}/dealer/city/sub/user/checkLoginName?oldLoginName=" + encodeURIComponent('${user.loginName}')}
                },
                messages: {
...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/dealer/city/sub/user/list">用户列表</a></li>
    <li class="active"><a href="#">用户${not empty user.id?'修改':'添加'}</a></li>
</ul><br/>

<form:form id="inputForm" modelAttribute="user" action="${ctx}/dealer/city/sub/user/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
