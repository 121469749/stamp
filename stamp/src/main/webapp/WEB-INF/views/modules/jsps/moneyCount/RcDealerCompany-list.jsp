...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            ...
            $("#searchForm").attr("action","${ctx}/dealer/moneyCount/rc/excelExport");
            $("#searchForm").submit();
            $("#searchForm").attr("action","${ctx}/dealer/moneyCount/rc/list");
        }
...
<form:form id="searchForm" modelAttribute="dealerCompantMoenyCountDTO" action="${ctx}/dealer/moneyCount/rc/list"
           method="post"
    ...
    <sys:treeselect id="area" name="area.id" value="${dealerCompantMoenyCountDTO.area.id}"
                    labelName="area.name"
    ...
    <input id="startDate" name="startDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
           value="<fmt:formatDate value="${dealerCompantMoenyCountDTO.startDate}" pattern="yyyy-MM-dd"/>"
    ...
    <input id="endDate" name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
           value="<fmt:formatDate value="${dealerCompantMoenyCountDTO.endDate}" pattern="yyyy-MM-dd"/>"
