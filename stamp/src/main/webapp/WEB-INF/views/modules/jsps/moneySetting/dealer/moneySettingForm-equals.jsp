        ...
        $(document).ready(function(){
            ...
            $('#submitForm').ajaxForm({
                ...
                success: function (result) {
                    ...
                    if(result.code==200){
                        <%--成功后跳转到列表页面--%>
                        window.location ="${ctx}/dealer/moneySetting/province/setting/list";
                    }else{
    ...
    <table class="table-bordered table" style="width: 55%;margin: 0 auto">
            ...
            <tr class="table-tr-title">
                <th colspan="10">
                    ...
                    正在对
                    <b style="color: blue;font-size: 18px">${agenyCompany.companyName}(${agenyCompany.area.name})</b>
                    进行收费设置
                </th>
                <!--收费公司-->
                <input type="hidden" name="company.id" value="${currentCompany.id}">
                <!--缴费区域-->
                <input type="hidden" name="area.id" value="${agenyCompany.area.id}">
            </tr>
            <tr class="table-tr-title">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="stampTexture" name="stampTexture" value="${phyMoneySetting.stampTexture}" type="hidden">
        ...
        <c:forEach items="${moneySettingVo.eleMoneySettings}" var="eleMoneySetting">
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="id" value="${eleMoneySetting.id}"></input>
