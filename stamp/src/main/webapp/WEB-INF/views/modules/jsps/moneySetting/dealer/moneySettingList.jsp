...
<head>
    ...
    <title>经销商（省）-经销商（市）-收费规则设定</title>
...
<body>
<%--输入页面名称--%>
<h3 style="width: 80%;margin: 10px auto">经销商（省）-经销商（市）-收费规则设定</h3>
        ...
        <tr>
            ...
            <td width="200px">
                <div style="width: 200px!important;">
                    <a href="${ctx}/dealer/moneySetting/province/setting/form?companyId=${agency.id}">收费规则</a>
                </div>
            </td>
        </tr>
    </c:forEach>
