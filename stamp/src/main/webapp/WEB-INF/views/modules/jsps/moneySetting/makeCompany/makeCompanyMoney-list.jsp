...
<body>
<%--输入页面名称--%>
<h3 style="width: 80%;margin: 10px auto">刻章单位-经销商管理列表</h3>
<form:form id="searchForm" modelAttribute="company" action="${ctx}/dealer/makeCompany/list" method="post" cssStyle="text-align: center">
