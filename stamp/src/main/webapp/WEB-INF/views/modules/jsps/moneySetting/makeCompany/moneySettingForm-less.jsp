        ...
        $(document).ready(function(){
            ...
            $('#submitForm').ajaxForm({
                ...
                success: function (result) {
                    ...
                    if(result.code==200){
                        <%--成功后跳转到列表页面--%>
                        window.location ="${ctx}/moneySetting/makeCompany/moneySetting/form";
                    }else{
...
<form id="submitForm" method="post" action="#">
    ...
    <table class="table-bordered table" style="width: 55%;margin: 0 auto">
            ...
            <tr class="table-tr-title">
                <th colspan="10">
                    <b style="color: blue;font-size: 18px">刻章点-${currentCompany.companyName}-(${currentCompany.area.name})</b>
                    正在进行收费设置修改
                </th>
                <!--收费公司-->
