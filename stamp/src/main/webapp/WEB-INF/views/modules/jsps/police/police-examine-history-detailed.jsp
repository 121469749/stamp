...
<div class="table-double">
        ...
        <div class="mod">
            <table class="table maintable table-striped table-bordered">
                ...
                <tr>
                    <td>企业名称</td>
                    <td>
                        <input type="text" value="${vo.company.companyName}" readonly>
                    </td>
                    <td>经济性质</td>
                    <td colspan="3">
                        <input type="text" value="${vo.company.busType}" readonly>
                    </td>
                </tr>
                <tr>
                    <td>企业地址</td>
    ...
    <div class="form-group">
        <label for="" class="phone-check-label">评审意见:</label><br>
        <label for=""class="phone-check-label"></label>
        <textarea style="width: 500px;height: 150px;padding: 5px" class="form-control" readonly>&nbsp;&nbsp;${vo.licence.checkReason}</textarea>
        <%--<input type="text" class="form-control phone-check-input" value="${vo.licence.checkReason}" readonly>--%>
    </div>
    <div class="form-group">
        <label for="" class="phone-check-label">结果:</label>
        ${vo.licence.checkState.value}
        <%--<input type="text" class="form-control phone-check-input" value="" readonly>--%>
    </div>
    <!--模态框-->
