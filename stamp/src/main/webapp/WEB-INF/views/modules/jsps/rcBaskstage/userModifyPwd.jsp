...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/rc/baskstage/user/reset/password" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="userType"></form:hidden>
		<div class="control-group">
			<div class="controls">
				你正在为用户类型是${user.userType.value},用户名是${user.loginName}的用户重置密码
			</div>
		</div>
		<div class="control-group">
