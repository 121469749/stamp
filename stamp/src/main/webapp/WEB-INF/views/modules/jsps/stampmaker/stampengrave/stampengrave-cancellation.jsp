...
<head>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#disposeForm').ajaxForm({
                dataType: 'json',
                type:"post",
                url: "${ctx}/stampMakeAction/disposeStamp",
...
<form:form id="disposeForm" modelAttribute="busniessHandler" action="" method="post" enctype="multipart/form-data" >
    ...
    <div>
        ...
        <div class="form-group">
            <label for="workRemarks" style="color: #3c3c3c">缴销原因：<p style="color: red"></p></label>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                  ${busniessHandler.useCompany.soleCode}
                </td>
                <th>单位类别</th>
                <td>
                        ${fns:getDictLabel(busniessHandler.useCompany.type1,"unitType" ,null )}
                </td>
                <%--<th>用章单位联系电话--%>

                <%--</th>--%>
                <%--<td>--%>
                    <%--${busniessHandler.useCompany.compPhone}--%>
                <%--</td>--%>
            </tr>
            <tr>
                <th>用章单位地址</th>
            ...
            <tr>
                <th>经办人姓名</th>
                <td>
                    <form:input id="personname" cssStyle="height:30px;width: 100%" path="tempAgent.agentName"></form:input>
                </td>
                <th>经办人联系电话</th>
                <td>
                    <form:input id="personphone" cssStyle="height:30px;width: 100%" path="tempAgent.agentPhone"></form:input>
                </td>
            </tr>
            <tr>
                <th>经办人证件类型</th>
                ...
                <th>经办人证件号码</th>
                <td>
                    <form:input id="personid" cssStyle="height:30px;width: 100%" path="tempAgent.agentCertCode"/>
                </td>
            </tr>
        </table>
    <table class="table table-striped table-bordered">
        <tr>
            <td rowspan="11" style="width: 10%;line-height:45px;text-align: center"><strong>附<br>件<br>材<br>料<br>上<br>传</strong></td>
        </tr>
        <tr>
            <td><font color="red">&nbsp;*</font>印章缴销许可证上传:</td>
        ...
        <center>
            <button class="btn-lg bg-primary"  type="button" id="my-btn2">缴销印章</button>
        </center>
