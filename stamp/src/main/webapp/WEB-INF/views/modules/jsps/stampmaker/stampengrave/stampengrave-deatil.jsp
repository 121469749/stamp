...
<div>
    <div class="panel-head">
        ...
        <h4 id="noph3">当前路径：首页 \ 已交付印章 \ 已交付印章详情</h4>
    ...
    <button class="btn btn-success" onclick="history.go(-1)" id="print2">返回上一页</button>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>${stampDeliveryVo.stamp.lastRecord.soleCode}</td>
            <th>企业类型</th>
            <td>${fns:getDictLabel(stampDeliveryVo.stamp.lastRecord.type1,"unitType" ,null )}</td>
            <%--<th>--%>
                <%--企业联系电话--%>
            <%--</th>--%>
            <%--<td>${stampDeliveryVo.stamp.lastRecord.compPhone}</td>--%>
        </tr>
        <tr>
            <th>企业住所</th>
            <td colspan="3">${stampDeliveryVo.stamp.lastRecord.compAddress}</td>
        </tr>
        <tr>
            <th>法人姓名</th>
            <td>${stampDeliveryVo.stamp.lastRecord.legalName}</td>
            <th>法人联系电话</th>
            <td>${stampDeliveryVo.stamp.lastRecord.legalPhone}</td>
        </tr>
        <tr>
            <th>法人证件类型</th>
            <td>
            ...
            <th>法人证件号码</th>
            <td>${stampDeliveryVo.stamp.lastRecord.legalCertCode}</td>
        </tr>
        <tr>
            <th>经办人姓名</th>
            <td>${stampDeliveryVo.stamp.lastRecord.agentName}</td>
            <th>经办人联系电话</th>
            <td>${stampDeliveryVo.stamp.lastRecord.agentPhone}</td>
        </tr>
        <tr>
            <th>经办人证件类型</th>
            <td>
            ...
            <th>经办人证件号码</th>
            <td>${stampDeliveryVo.stamp.lastRecord.agentCertCode}</td>
        </tr>
    </table>
    <table class="table table-striped table-bordered">
        <thead>
        ...
        <tr>
            ...
            <td align="center">
                ${fns:getDictLabel(stampDeliveryVo.stamp.stampTexture,"stampTexture",null)}
            </td>
            <td align="center">
...
<div style="text-align: center" id="print3">
