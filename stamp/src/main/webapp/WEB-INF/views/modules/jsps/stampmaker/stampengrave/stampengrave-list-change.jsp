...
<h4>变更印章列表</h4>
<form id="searchForm" action="${ctx}/stampMakePage/toChangeList" method="post">
    <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
    <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
    <label for="companyName" >印章公司名称:</label>
    <input id="companyName" name="useCompanyName" class="form-control" style="width: 200px;display: inline" type="text" value="${useCompanyName}">
    <select path="stampShape" class="form-control" style="width:120px;display: inline">
...
<table class="table-bordered table" style="width: 100%">
    ...
    <c:forEach items="${page.list}" var="stamp">
        <tr>
            ...
            <td>
                <a href="${ctx}/stampMakePage/toChange?id=${stamp.id}&stampShape=${stamp.stampShape}">变更印章</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
