...
<h4>缴销印章</h4>
<form id="searchForm" action="${ctx}/stampMakePage/toDisposeList" method="post">
...
<table class="table-bordered table" style="width: 100%">
    ...
    <c:forEach items="${page.list}" var="stamp">
        <tr>
            ...
            <td>
                <a href="${ctx}/stampMakePage/toDispose?id=${stamp.id}&stampShape=${stamp.stampShape}">缴销印章</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
