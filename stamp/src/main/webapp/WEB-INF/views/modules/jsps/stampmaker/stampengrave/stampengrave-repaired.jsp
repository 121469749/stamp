    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#repairForm').ajaxForm({
                dataType: 'json',
                type:"post",
                url: "${ctx}/stampMakeAction/repairStamp",
                success: function (result) {
                    alert(result.message);
                    if(result.code == 200){
                        document.location="${ctx}/stampMakePage/stampView";
                    }else {
                        $("#my-btn4").removeAttr("disabled");
                    }
                },
                error: function () {
                    alert("出错了！请联系管理员！");
...
<form:form id="repairForm" modelAttribute="busniessHandler" action="" method="post"
    ...
    <div>
        ...
        <div class="form-group">
            <label for="workRemarks" style="color: #3c3c3c">补刻原因：<p style="color: red"></p></label>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <th>单位类别</th>
            <td>${fns:getDictLabel(busniessHandler.useCompany.type1,"unitType" ,null )}
            </td>
            <%--<th>申请刻章单位联系电话--%>
            <%--</th>--%>
            <%--<td>${busniessHandler.useCompany.compPhone}--%>
                <%--<form:hidden cssStyle="height:30px;width: 100%" id="legalphone"  path="useCompany.compPhone"></form:hidden></td>--%>
        </tr>
        <tr>
            <th>申请刻章单位地址</th>
            <td colspan="3">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            <td><font color="red">&nbsp;*</font>印章补刻许可证上传:</td>
    ...
    <center>
        <button class="btn-lg bg-primary" type="button"  id="my-btn4">补刻提交</button>
    </center>
</div>
</form:form>
<!--模态框-->
