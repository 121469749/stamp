...
<div class="table-double">
    <!--左边导航-->
    <div class="table-left" style="text-align: center">
        <ul>
            <%--<li><a href="#">开办流程</a></li>--%>
    ...
    <div class="table-right">
        <p> ${result == null ? "":  "上次开办申请审核结果为"} ${result == null ? "":  result.checkState.getValue()}
            <c:if test="${result != null}">
            <a href="${ctx}/makeStampPage/openLicensefinish" >查看上次申请的信息详情</a>
        </c:if>
        ...
        <form:form id="mainform" modelAttribute="licenseApplyDTO" action="${ctx}/makeStampAction/submit" method="post" class="form-horizontal" enctype="multipart/form-data">
            <input  name="licence.workType" type="text" id="legalName" class="form-control hide" value="OPEN"/>
            ...
            <div class="mod">
                ...
                <table class="table maintable table-striped table-bordered">
                    ...
                    <tr>
                        <td>治安负责人姓名</td>
                        <td>
                            <form:input  path="licence.policeName" type="text" id="securityperson" class="form-control" placeholder="输入治安负责人姓名"/>
                        </td>
                        <td>负责人身份证号码</td>
                        <td>
        ...
        $("#mainperson-id").blur(function () {
            if ($(this).val().length != 18) {
                if ($(this).next().length) {
                    ...
                    $(this).after("<label>请输入法人证件号码</label>");
                }
            } else {
                $(this).next().remove();
            }
        ...
        $("#mainperson-phone").blur(function () {
            if ($(this).val().length != 11) {
                if ($(this).next().length) {
                    ...
                    $(this).after("<label>请输入法人联系电话</label>");
                }
            } else {
                $(this).next().remove();
            }
        ...
        $("#securityperson").blur(function () {
            if ($(this).val() == "") {
                if ($(this).next().length) {
                    ...
                    $(this).after("<label>请输入治安负责人姓名</label>");
                }
            } else {
                $(this).next().remove();
            }
        ...
        $("#securityperson-id").blur(function () {
            if ($(this).val().length != 18) {
                if ($(this).next().length) {
                    ...
                    $(this).after("<label>请输入治安负责人证件号码</label>");
                }
            } else {
                $(this).next().remove();
            }
