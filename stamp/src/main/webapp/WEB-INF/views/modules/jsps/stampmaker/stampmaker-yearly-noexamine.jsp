...
<head>
    ...
    <title>刻章点-年审申请(已申请过，未审核完)</title>
...
<div class="table-double">
    ...
    <div class="table-left">
        <ul>
            <li><a href="#">年审流程</a></li>
            <li class="select"><a href="#">年审申请</a></li>
            <li><a href="#">网上咨询</a></li>
        </ul>
    </div>
    <!---右边部分-->
            ...
            <div class="mod">
                <div class="panel-head" style="font-size: 14px">
                    <b><span class="fa fa-address-book-o"></span>
                        &nbsp;年审申请</b>
                    <p>
                        您当前已经有申请正在审批，当前审批状态：审核中，具体申请信息如下：
                    </p>
                </div>
                <table class="table maintable table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>联系电话</td>
                        <td>
                            <input type="text" id="mainperson-phone" class="form-control readonly" value="${vo.licence.legalPhone}"
                                   readonly>
                        </td>
                    </tr>
                    <tr>
