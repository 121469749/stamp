...
<div class="table-double">
    ...
    <div class="table-right">
        <p> ${result == null ? "":  "上次年审申请审核结果为"} ${result == null ? "":  result.checkState.getValue()}
            <c:if test="${result != null}">
                <a href="${ctx}/makeStampPage/annualfinish" target="_blank">查看上次申请的信息详情</a>
            </c:if>
        ...
        <form:form id="mainform" modelAttribute="licenseApplyDTO" action="${ctx}/makeStampAction/submit" method="post" class="form-horizontal" enctype="multipart/form-data">
            <input  name="licence.workType" type="text" id="legalName" class="form-control hide" value="ANNUAL"/>
