...
<div>
    <div class="clearfix">
        <ul class="clearfix">
            ...
            <li><a class="active" href="${ctx}/useCompanyStampPage/showDestroy?stampShape=${stamp.stampShape}">缴销</a></li>
    ...
    <div id="using">
        <form:form id="searchForm" modelAttribute="stamp" action="${ctx}/useCompanyStampPage/showDestroy?stampShape=${stamp.stampShape}" method="post">
        ...
        <table class="table-bordered table" style="width: 80%">
            ...
            <c:forEach items="${page.list}" var="stamp">
                <tr>
                    ...
                    <td><input type="text" value="已缴销" readonly></td>
