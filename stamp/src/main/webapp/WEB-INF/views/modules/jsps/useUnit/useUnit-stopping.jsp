...
<div>
        ...
        <ul class="clearfix">
            ...
            <c:choose>
                <c:when test="${stamp.stampShape == '2'}">
                    <li><a class="active" href="${ctx}/useCompanyStampPage/showStop?stampShape=${stamp.stampShape}">停用</a></li>
                </c:when>
            </c:choose>
    ...
    <div id="using">
        <form:form id="searchForm" modelAttribute="stamp" action="${ctx}/useCompanyStampPage/showStop?stampShape=${stamp.stampShape}" method="post">
        ...
        <table class="table-bordered table" style="width: 80%">
            ...
            <c:forEach items="${page.list}" var="stamp">
                <tr>
                    ...
                    <td><input type="text" value="已停用" readonly></td>
