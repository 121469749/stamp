...
<div>
    <div class="clearfix">
        <ul class="clearfix">
            <li><a class="active" href="${ctx}/useCompanyStampPage/showUsing?stampShape=${stamp.stampShape}">使用中</a></li>
    ...
    <div id="using">
        <div class="search" id="search">
            <form:form id="searchForm" modelAttribute="stamp" action="${ctx}/useCompanyStampPage/showUsing?stampShape=${stamp.stampShape}" method="post">
                ...
                <c:forEach items="${page.list}" var="stamp">
                    <tr>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${stamp.stampShape == '2'}">
                                <td><shiro:hasPermission name="useCompany:edit"><a href="${ctx}/useCompanyStampPage/findStampInfo?stamp.id=${stamp.id}&stamp.stampShape=${stamp.stampShape}" class="btn btn-xs btn-default">管理</a></shiro:hasPermission></td>
                            </c:when>
                        </c:choose>
