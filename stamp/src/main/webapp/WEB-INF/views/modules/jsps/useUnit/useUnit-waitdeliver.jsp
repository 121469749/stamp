...
<div>
    <div class="clearfix">
        <ul class="clearfix">
            ...
            <li><a class="active" href="${ctx}/useCompanyStampPage/showMade?stampShape=${stamp.stampShape}">待交付</a></li>
            ...
            <li><a href="${ctx}/useCompanyStampPage/showMissing?stampShape=${stamp.stampShape}">挂失</a></li>
    ...
    <div id="using">
        <form:form id="searchForm" modelAttribute="stamp" action="${ctx}/useCompanyStampPage/showMade?stampShape=${stamp.stampShape}" method="post">
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <form:input path="stampName" class="form-control" id="name" cssStyle="width: 200px;display: inline" htmlEscape="false"/>
                    </td>
                    <td>&nbsp;</td>
                    <%--<td>--%>
        ...
        <table class="table-bordered table" style="width: 80%">
            <tbody>
            <tr>
                <th><input type="text" value="印章名称" readonly></th>
                <th><input type="text" value="印章类型" readonly></th>
                <th><input type="text" value="刻章点" readonly></th>
                <th><input type="text" value="状态" readonly></th>
                <th><input type="text" value="详情" readonly></th>
            </tr>
            <c:forEach items="${page.list}" var="stamp">
                <tr>
                    ...
                    <td><input type="text" value="${stamp.nowMakeComp.companyName}" readonly></td>

                    <td><input type="text" value="待交付" readonly></td>
