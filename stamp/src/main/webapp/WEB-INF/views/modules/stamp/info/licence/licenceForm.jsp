...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/stamp.info/licence/licence/">许可证业务列表</a></li>
		<li class="active"><a href="${ctx}/stamp.info/licence/licence/form?id=${licence.id}">许可证业务<shiro:hasPermission name="stamp.info:licence:licence:edit">${not empty licence.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="stamp.info:licence:licence:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="licence" action="${ctx}/stamp.info/licence/licence/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">办理业务类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">办理业务理由：</label>
			<div class="controls">
				<form:input path="workReason" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">经办人身份证号码：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">企业经营：</label>
			<div class="controls">
				<form:input path="busRun" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">审核状态：</label>
			<div class="controls">
				<form:input path="checkState" htmlEscape="false" maxlength="10" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="checkReason" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="stamp.info:licence:licence:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
