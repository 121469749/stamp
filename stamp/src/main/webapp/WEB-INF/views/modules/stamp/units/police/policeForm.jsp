...
<body>
	...
	<form:form id="inputForm" modelAttribute="police" action="${ctx}/stamp/units/police/police/savePolice" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">所属区域：</label>
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${police.area.id}" labelName="area.name" labelValue="${police.area.name}"
