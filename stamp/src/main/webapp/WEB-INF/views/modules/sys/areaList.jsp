...
//            var common = document.createComment("aa");
//            var parent = treeTable.parentNode;
//            parent.replaceChild(common,treeTable);
//            var fragment = document.createDocumentFragment();
//            fragment.appendChild(treeTable);
//			$(fragment).treeTable({expandLevel : 1});
//            parent.replaceChild(treeTable,common);
            console.timeEnd();
		});
		function addRow(list, tpl, data, pid,root){
			for (var i=0; i<data.length; i++){
				...
				if ((${fns:jsGetVal('row.parentId')}) == pid){
					...
					addRow(list, tpl, data, row.id,false);
				}
			}
		}
	</script>
