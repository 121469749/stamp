...
<!-- 	</ul> -->
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post" class="breadcrumb form-search">
		...
		<div>
			...
			<label>用户类型:</label><select name="userType">
			<option value="ADMIN">系统管理员</option>
			<option value="USE">用章公司</option>
			<option value="MAKE">制章点</option>
			<option value="AGENY">经销商</option>
			<option value="POLICE">公安部门</option>
		</select>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="log">
			<tr>
				...
				<td>${log.createBy.userType.value}</td>
