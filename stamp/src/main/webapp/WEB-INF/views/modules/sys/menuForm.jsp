...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">菜单所属用户组:</label>
			<div class="controls" id="check">
				<input id="roleType0" class="required" type="checkbox" value="0">
				<label for="roleType0">全选</label>
				<br>
				<form:checkboxes path="roleType" items="${fns:getDictList('sys_role_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"></form:checkboxes>
