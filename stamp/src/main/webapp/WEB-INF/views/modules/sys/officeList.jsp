...
<head>
	...
	<script type="text/javascript">
        ...
        function query() {
            $('#searchForm').submit();
            <%--$('#officeContent').attr("src","${ctx}/sys/office/list2");--%>
        }
...
<body>
	...
	<form:form id="searchForm" modelAttribute="office" action="${ctx}/sys/office/list2" method="post" class="breadcrumb form-search ">
		<div style="width: 1300px;text-align: center">
			<ul class="ul-form">
				<li><label>机构名称:</label>
					<form:input id="officeName" path="name" class="input-medium" maxlength="100" cssStyle="width: 250px"/></li>
				<li><label>所属区域:</label>
