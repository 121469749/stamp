...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.office.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="userType" class="input-xlarge required">
					...
					<form:options items="${userTypes}" itemLabel="value" />
				</form:select>
			</div>
		</div>
		<div class="control-group">
